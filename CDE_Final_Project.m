...
Y = Data(:,27); %womens graduate rate column
Y = table2array(Y);

Data(:,27) = []; %delete women graduation rate column
...
mdl = fitlm(lData,'linear','ResponseVar','GraduationRate_Bachelor_sDegreeWithin6Years_Women','PredictorVars',minMSEModel)
