...
Y = Data(:,19); %hispanic graduate rate column
Y = table2array(Y);
...
%%
mdl = fitlm(lData,'linear','ResponseVar','GraduationRate_Bachelor_sDegreeWithin6Years_Hispanic','PredictorVars',minMSEModel)
